      ...
      if (usertype[0].active === false) {
        ...
        collectionPermissions.find({ role: userType }, function (e, results) {
          ...
          if (ac._isLocked) {
            ...
            console.log("dash1", req.query.dash1);
            console.log("dash2", req.query.dash2);
            var tasks = [
              // Load Events
              function (callback) {
                ...
                collection1.find({}, {}, function (e, events) {
                  ...
                  for (i = 0; i < events.length; i++) {
                    ...
                    if (!req.query.dash1) {
                      if (
                        moment(events[i].eventTimeIn).isSame(
                          dateToday,
                          "month"
                        ) == true
                      ) {
                        ...
                        if (
                          isItemInArray(eventAgentActivity, [
                            events[i].agentAbbrev,
                          ]) == false
                        ) {
                          ...
                          for (var l = 0; l < eventAgentActivity.length; l++) {
                            if (
                              eventAgentActivity[l][0] == events[i].agentAbbrev
                            ) {
                              eventAgentActivity[l][1] =
                                eventAgentActivity[l][1] + 1;
                            }
                          }
                        }
                      }
                      ...
                      if (
                        moment(events[i].eventTimeIn).isSame(
                          moment(req.query.dash1, "MM-YYYY"),
                          "month"
                        )
                      ) {
                        eventListMonth.push(events[i]);
                    ...
                    if (!req.query.dash2) {
                      if (
                        ...
                        monthlyVisitTotal[
                          moment(events[i].eventTimeIn).month()
                        ][1]++;
                      }
                    } else {
                      if (
                    ...
                    if (
                      moment(events[i].eventTimeIn).isAfter(
                        dateLess30,
                        "day"
                      ) == true
                    ) {
                      eventList30.push([
                        events[i].clientName,
                        events[i].eventTimeIn,
                      ]);
                      if (
                        isItemInArray(clientVisit30, [events[i].clientName]) ==
                        false
                      ) {
                    ...
                    if (
                      moment(events[i].eventTimeIn).isBefore(
                        dateLess30,
                        "day"
                      ) == true
                    ) {
                      eventListMore30.push([
                        events[i].clientName,
                        events[i].eventTimeIn,
                      ]);
                    }
                  ...
                  for (p = 0; p < eventListMore30.length; p++) {
                    if (
                      isItemInArray(eventList30, [eventListMore30[p][0]]) ==
                      false
                    ) {
                  ...
                  for (i = 0; i < tempVisitDue.length; i++) {
                    if (
                      isItemInArray(visitDue, [tempVisitDue[i][0]]) == false
                    ) {
                      visitDue.push(tempVisitDue[i]);
                    } else {
                      for (j = 0; j < visitDue.length; j++) {
                        if (visitDue[j][0] == tempVisitDue[i][0]) {
                          visitDue[j][1] = moment.max(
                            moment(visitDue[j][1]),
                            moment(tempVisitDue[i][1])
                          );
                        }
                      }
                    }
                  ...
                  console.log(
                    "Events Past 30 Days (eventList30):" + eventList30.length
                  );
                  console.log(
                    "Events Beyond 30 Days Prior (eventListMore30):" +
                      eventListMore30.length
                  );
                  console.log(
                    "Events w/ Clients not Visited in the Past 30 Days (tempVisitDue):" +
                      tempVisitDue.length
                  );
                  console.log(
                    "Number of Customers not Visited Past 30 (visitDue):" +
                      visitDue.length
                  );
              ...
              function (callback) {
                winston.info("client function called");
                ...
                collection2.find({}, {}, function (e, clients) {
                  ...
                  if (req.user.usertype == "Agent") {
                    ...
                    for (i = 0; i < visitDue.length; i++) {
                      for (j = 0; j < clients.length; j++) {
                        if (
                          visitDue[i][0] == clients[j].clientName &&
                          req.user.agentAbbrev == clients[j].agentAbbrev
                        ) {
                  ...
                  console.log(
                    "Number of Customers not Visited Past 30 for this Agent (visitDue):" +
                      filteredVisitDue.length
                  );
      ...
      collectionPermissions.find({ role: userType }, {}, function (e, results) {
        ...
        if (permission.granted) {
          ...
          async.parallel(tasks, function (err) {
            //This function gets called after the three tasks have called their "task callbacks"
    ...
    function (e, usertype) {
      ...
      collectionPermissions.find({ role: userType }, {}, function (e, results) {
        ...
        if (permission.granted) {
          ...
          if (req.user.usertype == "Agent") {
            collection.find(
              { agentAbbrev: req.user.agentAbbrev },
              function (e, docs) {
    ...
    function (e, usertype) {
      ...
      collectionPermissions.find({ role: userType }, {}, function (e, results) {
        ...
        if (permission.granted) {
          // Perform what is allowed when permission is granted
          // Set our internal DB variable
          var dateStartInput = moment(
            req.body.dateStartInput.concat(" 00:00:00"),
            "YYYY-MM-DD HH-mm-ss"
          ).toDate();
          var dateEndInput = moment(
            req.body.dateEndInput.concat(" 23:59:59"),
            "YYYY-MM-DD HH-mm-ss"
          ).toDate();
          var dateRange =
            req.body.dateStartInput + " - " + req.body.dateEndInput;
          var db = req.db;
          ...
          if (req.body.activityTypeSelect == "") {
            query = {
              $and: [
                ...
                { "eventTimeIn._d": { $lte: dateEndInput } },
                { "eventTimeIn._d": { $gte: dateStartInput } },
              ],
            };
          } else {
            query = {
              $and: [
                { agentAbbrev: req.body.agentSelect },
                { eventType: req.body.activityTypeSelect },
                { "eventTimeIn._d": { $lte: dateEndInput } },
                { "eventTimeIn._d": { $gte: dateStartInput } },
              ],
            };
        ...
        if (permission.granted) {
          ...
          var query = {
            $and: [
              ...
              { "eventTimeIn._d": { $lte: new Date(dateEndInput._d) } },
              { "eventTimeIn._d": { $gte: new Date(dateStartInput._d) } },
            ],
          };
        ...
        if (permission.granted) {
          ...
          var query = {
            $and: [
              ...
              {
                $or: [
                  { contact1: req.body.contactID1 },
                  { contact2: req.body.contactID1 },
                ],
              },
              { "eventTimeIn._d": { $lte: new Date(dateEndInput._d) } },
              { "eventTimeIn._d": { $gte: new Date(dateStartInput._d) } },
          ...
          var query = [
            ...
            },
            {
              $group: {
                _id: "$clientName",
                visitCount: { $sum: 1 },
                totalDuration: { $sum: "$eventDuration" },
                eventDates: { $push: "$eventTimeIn._d" },
              },
            },
          ];
            ...
            function (callback) {
              ...
              collection1.find({}, {}, function (e, events) {
                ...
                for (i = 0; i < events.length; i++) {
                  //Filter number of visits per Agent
                  if (
                    moment(events[i].eventTimeIn).isSame(dateToday, "month") ==
                    true
                  ) {
                    eventListMonth.push(events[i]);
                    if (
                  ...
                  //Filter number of visits per Client
                  if (
                    moment(events[i].eventTimeIn).isAfter(dateLess30, "day") ==
                    true
                  ) {
                    eventList30.push([
                      events[i].clientName,
                  ...
                  //Filter Events beyond 30 days ago
                  if (
                    moment(events[i].eventTimeIn).isBefore(dateLess30, "day") ==
                    true
                  ) {
                    eventListMore30.push([
                      events[i].clientName,
                ...
                for (p = 0; p < eventListMore30.length; p++) {
                  if (
                    isItemInArray(eventList30, [eventListMore30[p][0]]) == false
                  ) {
                    tempVisitDue.push(eventListMore30[p]);
                  }
                }
        ...
        if (permission.granted) {
          ...
          var tasks = [
            ...
            function (callback) {
              ...
              collection2.find(
                { contactClientID: req.body.clientSelect },
                { contactFirstName: 1, contactLastName: 1 },
                function (e, contact) {
                  if (e) return callback(e);
        ...
        if (permission.granted) {
          ...
          var tasks = [
            ...
            function (callback) {
              var collection2 = db.get("Contacts");
              collection2.update(
                { contactClientID: req.body.origClientName },
                { $set: { contactClientID: newClientName } },
                { multi: true },
                function (e, contact) {
                  if (e) return callback(e);
                  callback();
            ...
            function (callback) {
              ...
              collection1.find(
                ...
                function (e, contact) {
                  ...
                  contactName =
                    result.contact[0].contactFirstName +
                    " " +
                    result.contact[0].contactLastName;
                  callback();
                }
              );
            },
        ...
        if (permission.granted) {
          ...
          var tasks = [
            ...
            function (callback) {
              ...
              collection4.find(
                { _id: new ObjectID(req.body.submit) },
                {},
                function (e, events) {
                  if (e) return callback(e);
                  result.events = events;
    ...
    function (e, usertype) {
      ...
      collectionPermissions.find({ role: userType }, {}, function (e, results) {
        ...
        if (permission.granted) {
          ...
          var eventDateTimeIn = moment(
            eventDate.concat(" ", req.body.eventTimeIn),
            "YYYY-MM-DD HH-mm"
          );
          var eventDateTimeOut = moment(
            eventDate.concat(" ", req.body.eventTimeOut),
            "YYYY-MM-DD HH-mm"
          );
          var eventDuration = parseInt(
            moment.duration(eventDateTimeOut.diff(eventDateTimeIn)).asMinutes()
          );
          ...
          var tasks = [
            ...
            function (callback) {
              ...
              collection3.update(
                ...
                { $set: { agentAbbrev: req.body.agentAbbrev } },
                { multi: true },
                function (e, contact) {
                  if (e) return callback(e);
                  callback();
